...
export default function Header() {
  return (
      <header className='h-[10vh] bg-sky-900 flex items-center justify-between px-6'>
          <div className='text-3xl text-gray-50 font-bold'>InsentApp(A ZoomInfo Company)</div>
          <div className='text-xl flex items-center space-x-3 text-gray-50 font-semibold'>
